...
<div class="page-head">
    <ol class="breadcrumb">
        ...
        <button type="button" title="添加分类" id="category-add" class="btn btn-default btn-xs"><i class="fa fa-file"></i>
        </button>
    </ol>
</div>
<div class="row">
    ...
    $(function () {
        ...
        $('.fa-trash-o').click(function () {
            ...
            layer.confirm('删除后，该分类下的博客将暂无分类，仍然删除？', {
                ...
                $.ajax({
                    type: "get",
                    url: "${pageContext.request.contextPath}/bms/category/delSubmit.do?sn=" + delId,
                    cache: false,
