...
;layui.define(["jquery", "element", "nprogress"], function (i) {
    var t = layui.jquery, e = layui.element, a = t(document), l = t(window), n = function () {
        this.config = {elem: void 0, mainUrl: getRootPath() + "/bms/main.do"}, this.v = "1.0.2"
    };
